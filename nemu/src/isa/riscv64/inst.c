...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
    ...
    INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall , I, s->dnpc = isa_raise_intr(0x0b, s->pc));  // 按道理应该读a7的值(前一句为li a7 -1),但是为了能用difftest这边参照了spike填0x0b
    INSTPAT("0011000 00010 00000 000 00000 11100 11", mret  , R, s->dnpc = isa_mret());
    ...
    INSTPAT("??????? ????? ????? 001 ????? 00011 11", fencei , N, );                                                                    // fencei == nop.
