...
VL_INLINE_OPT void Vriscv___024root___sequent__TOP__0(Vriscv___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        if ((0x13U == (0x7fU & vlSelf->riscv__DOT__if_id_inst_o))) {
            ...
            if ((0U == (7U & (vlSelf->riscv__DOT__if_id_inst_o 
                ...
                vlSelf->riscv__DOT__id_ex_rd_addr_o 
                    = (0x1fU & (vlSelf->riscv__DOT__if_id_inst_o 
                                >> 7U));
                vlSelf->riscv__DOT__id_ex_op1_o = vlSelf->riscv__DOT__regs_rs1_rdata_o;
                vlSelf->riscv__DOT__id_ex_op2_o = ((IData)(vlSelf->rst)
                                                    ? 
                                                   ((0U 
            ...
            vlSelf->riscv__DOT__id_ex_reg_wen = 0U;
            vlSelf->riscv__DOT__id_ex_rd_addr_o = (0x1fU 
                                                   & 0U);
            vlSelf->riscv__DOT__id_ex_op1_o = 0U;
            vlSelf->riscv__DOT__id_ex_op2_o = 0U;
        }
    ...
    vlSelf->riscv__DOT__if_id_inst_addr_o = ((IData)(vlSelf->rst)
                                              ? vlSelf->riscv__DOT__pc_reg_pc_o
                                              : 0U);
    if ((0x13U == (0x7fU & vlSelf->riscv__DOT__id_ex_inst_o))) {
        if ((0U == (7U & (vlSelf->riscv__DOT__id_ex_inst_o 
                          >> 0xcU)))) {
        ...
        vlSelf->riscv__DOT__ex_reg_wen_o = (IData)(
                                                   (0x33U 
                                                    == 
                                                    (0x707fU 
                                                     & vlSelf->riscv__DOT__id_ex_inst_o)));
        if ((0x33U == (0x7fU & vlSelf->riscv__DOT__id_ex_inst_o))) {
            if ((0U == (7U & (vlSelf->riscv__DOT__id_ex_inst_o 
                              >> 0xcU)))) {
                if ((0U == (vlSelf->riscv__DOT__id_ex_inst_o 
                            >> 0x19U))) {
                    vlSelf->riscv__DOT__ex_rd_addr_o 
                    ...
                    vlSelf->riscv__DOT__ex_rd_addr_o 
                        = (0x1fU & (vlSelf->riscv__DOT__id_ex_inst_o 
                                    >> 7U));
                    vlSelf->riscv__DOT__ex_rd_data_o 
                        = (vlSelf->riscv__DOT__id_ex_op2_o 
                           - vlSelf->riscv__DOT__id_ex_op1_o);
