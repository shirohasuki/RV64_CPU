...
VL_ATTR_COLD void Vtb___024root__trace_init_sub__TOP__0(Vtb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+241,"mem_inst_addr_o", false,-1, 63,0);
    ...
    tracep->declQuad(c+243,"wb_inst_addr_o", false,-1, 63,0);
    ...
    tracep->declBit(c+218,"rst", false,-1);
    tracep->declBit(c+237,"hold_flag_i", false,-1);
    tracep->declBus(c+250,"set_data", false,-1, 7,0);
    ...
    tracep->declBit(c+218,"rst", false,-1);
    tracep->declBit(c+237,"hold_flag_i", false,-1);
    tracep->declBus(c+252,"set_data", false,-1, 4,0);
    ...
    tracep->pushNamePrefix("dff1 ");
    tracep->declBus(c+253,"DW", false,-1, 31,0);
    tracep->declBit(c+217,"clk", false,-1);
    tracep->declBit(c+218,"rst", false,-1);
    tracep->declBit(c+2,"hold_flag_i", false,-1);
    tracep->declBus(c+254,"set_data", false,-1, 31,0);
    ...
    tracep->declBit(c+237,"hold_flag_i", false,-1);
    tracep->declQuad(c+246,"set_data", false,-1, 63,0);
    tracep->declQuad(c+241,"data_i", false,-1, 63,0);
    ...
    tracep->declQuad(c+243,"inst_addr_i", false,-1, 63,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declQuad(c+142+i*2,"regs", true,(i+0), 63,0);
    }
    tracep->declQuad(c+243,"pc_reg", false,-1, 63,0);
    ...
    tracep->declQuad(c+243,"inst_addr_o", false,-1, 63,0);
    tracep->declBus(c+59,"reg_waddr_i", false,-1, 4,0);
    tracep->declQuad(c+41,"reg_wdata_i", false,-1, 63,0);
...
VL_ATTR_COLD void Vtb___024root__trace_full_sub_0(Vtb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullQData(oldp+241,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__mem_inst_addr_o),64);
    tracep->fullQData(oldp+243,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__wb_inst_addr_o),64);
    tracep->fullIData(oldp+245,(0x40U),32);
    tracep->fullQData(oldp+246,(0ULL),64);
    tracep->fullIData(oldp+248,(1U),32);
    tracep->fullIData(oldp+249,(8U),32);
    tracep->fullCData(oldp+250,(0U),8);
    tracep->fullIData(oldp+251,(5U),32);
    tracep->fullCData(oldp+252,(0U),5);
    tracep->fullIData(oldp+253,(0x20U),32);
    tracep->fullIData(oldp+254,(0x13U),32);
}
