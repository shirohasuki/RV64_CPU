...
VL_ATTR_COLD void Vtb___024root__trace_init_sub__TOP__0(Vtb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+76,"id_op1_o", false,-1, 31,0);
    tracep->declBus(c+77,"id_op2_o", false,-1, 31,0);
    tracep->declBus(c+11,"id_rd_addr_o", false,-1, 4,0);
    tracep->declBit(c+12,"id_reg_wen", false,-1);
    tracep->declBus(c+78,"regs_rs1_rdata_o", false,-1, 31,0);
    tracep->declBus(c+79,"regs_rs2_rdata_o", false,-1, 31,0);
    ...
    tracep->declBit(c+82,"ex_hold_flag_o", false,-1);
    ...
    tracep->declBit(c+82,"hold_flag_ex_i", false,-1);
    ...
    tracep->declBus(c+22,"jump_addr_o", false,-1, 31,0);
    tracep->declBit(c+23,"jump_en_o", false,-1);
    tracep->declBit(c+82,"hold_flag_o", false,-1);
    ...
    tracep->declBus(c+29,"shamt", false,-1, 4,0);
    ...
    tracep->declBus(c+35,"SRA_mask", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+76,"op1_i", false,-1, 31,0);
    tracep->declBus(c+77,"op2_i", false,-1, 31,0);
    ...
    tracep->declBit(c+81,"rst", false,-1);
    tracep->declBit(c+24,"hold_flag_i", false,-1);
    tracep->declBus(c+84,"set_data", false,-1, 31,0);
    ...
    tracep->declBit(c+81,"rst", false,-1);
    tracep->declBit(c+24,"hold_flag_i", false,-1);
    tracep->declBus(c+85,"set_data", false,-1, 31,0);
    ...
    tracep->declBit(c+24,"hold_flag_i", false,-1);
    tracep->declBus(c+85,"set_data", false,-1, 31,0);
    tracep->declBus(c+76,"data_i", false,-1, 31,0);
    ...
    tracep->declBit(c+24,"hold_flag_i", false,-1);
    tracep->declBus(c+85,"set_data", false,-1, 31,0);
    tracep->declBus(c+77,"data_i", false,-1, 31,0);
    ...
    tracep->declBit(c+81,"rst", false,-1);
    tracep->declBit(c+24,"hold_flag_i", false,-1);
    tracep->declBus(c+87,"set_data", false,-1, 4,0);
    tracep->declBus(c+11,"data_i", false,-1, 4,0);
    tracep->declBus(c+17,"data_o", false,-1, 4,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("dff6 ");
    tracep->declBus(c+88,"DW", false,-1, 31,0);
    tracep->declBit(c+80,"clk", false,-1);
    tracep->declBit(c+81,"rst", false,-1);
    tracep->declBit(c+24,"hold_flag_i", false,-1);
    tracep->declBus(c+82,"set_data", false,-1, 0,0);
    ...
    tracep->declBus(c+8,"inst_i", false,-1, 31,0);
    tracep->declBus(c+7,"inst_addr_i", false,-1, 31,0);
    tracep->declBus(c+78,"rs1_data_i", false,-1, 31,0);
    tracep->declBus(c+79,"rs2_data_i", false,-1, 31,0);
    ...
    tracep->declBus(c+76,"op1_o", false,-1, 31,0);
    tracep->declBus(c+77,"op2_o", false,-1, 31,0);
    ...
    tracep->declBus(c+42,"imm", false,-1, 11,0);
    tracep->declBus(c+40,"shamt", false,-1, 4,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+78,"rs1_rdata_o", false,-1, 31,0);
    tracep->declBus(c+79,"rs2_rdata_o", false,-1, 31,0);
...
VL_ATTR_COLD void Vtb___024root__trace_full_sub_0(Vtb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullIData(oldp+22,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__ex_jump_addr_o),32);
    ...
    tracep->fullIData(oldp+35,((0xffffffffU >> (0x1fU 
                                                & vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_ex_op2_o))),32);
    tracep->fullCData(oldp+36,((0x7fU & vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o)),7);
    tracep->fullCData(oldp+37,((0x1fU & (vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                         >> 7U))),5);
    tracep->fullCData(oldp+38,((7U & (vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                      >> 0xcU))),3);
    tracep->fullCData(oldp+39,((0x1fU & (vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                         >> 0xfU))),5);
    tracep->fullCData(oldp+40,((0x1fU & (vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                         >> 0x14U))),5);
    tracep->fullCData(oldp+41,((vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                >> 0x19U)),7);
    tracep->fullSData(oldp+42,((vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                >> 0x14U)),12);
    tracep->fullIData(oldp+43,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[0]),32);
    tracep->fullIData(oldp+44,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[1]),32);
    tracep->fullIData(oldp+45,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[2]),32);
    tracep->fullIData(oldp+46,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[3]),32);
    tracep->fullIData(oldp+47,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[4]),32);
    tracep->fullIData(oldp+48,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[5]),32);
    tracep->fullIData(oldp+49,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[6]),32);
    tracep->fullIData(oldp+50,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[7]),32);
    tracep->fullIData(oldp+51,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[8]),32);
    tracep->fullIData(oldp+52,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[9]),32);
    tracep->fullIData(oldp+53,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[10]),32);
    tracep->fullIData(oldp+54,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[11]),32);
    tracep->fullIData(oldp+55,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[12]),32);
    tracep->fullIData(oldp+56,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[13]),32);
    tracep->fullIData(oldp+57,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[14]),32);
    tracep->fullIData(oldp+58,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[15]),32);
    tracep->fullIData(oldp+59,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[16]),32);
    tracep->fullIData(oldp+60,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[17]),32);
    tracep->fullIData(oldp+61,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[18]),32);
    tracep->fullIData(oldp+62,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[19]),32);
    tracep->fullIData(oldp+63,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[20]),32);
    tracep->fullIData(oldp+64,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[21]),32);
    tracep->fullIData(oldp+65,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[22]),32);
    tracep->fullIData(oldp+66,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[23]),32);
    tracep->fullIData(oldp+67,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[24]),32);
    tracep->fullIData(oldp+68,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[25]),32);
    tracep->fullIData(oldp+69,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[26]),32);
    tracep->fullIData(oldp+70,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[27]),32);
    tracep->fullIData(oldp+71,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[28]),32);
    tracep->fullIData(oldp+72,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[29]),32);
    tracep->fullIData(oldp+73,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[30]),32);
    tracep->fullIData(oldp+74,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs[31]),32);
    tracep->fullIData(oldp+75,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__unnamedblk1__DOT__i),32);
    tracep->fullIData(oldp+76,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_op1_o),32);
    tracep->fullIData(oldp+77,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_op2_o),32);
    tracep->fullIData(oldp+78,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_rs1_rdata_o),32);
    tracep->fullIData(oldp+79,(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_rs2_rdata_o),32);
    ...
    tracep->fullIData(oldp+84,(0x13U),32);
    tracep->fullIData(oldp+85,(0U),32);
    tracep->fullIData(oldp+86,(5U),32);
    tracep->fullCData(oldp+87,(0U),5);
    tracep->fullIData(oldp+88,(1U),32);
}
