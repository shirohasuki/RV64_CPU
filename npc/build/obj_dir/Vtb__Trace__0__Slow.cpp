...
VL_ATTR_COLD void Vtb___024root__trace_full_sub_0(Vtb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullQData(oldp+70,(((QData)((IData)((vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                                 >> 0xcU))) 
                                << 0xcU)),64);
    tracep->fullQData(oldp+72,((((QData)((IData)((0xfffffU 
                                                  & (- (IData)(
    ...
    tracep->fullQData(oldp+76,((((QData)((IData)((0xfffU 
                                                  & (- (IData)(
                                                               (vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o 
                                                                >> 0x1fU)))))) 
                                 << 0x14U) | (QData)((IData)(
