...
VL_INLINE_OPT void Vtb___024root___sequent__TOP__0(Vtb___024root* vlSelf) {
    ...
    SData/*11:0*/ __Vdlyvdim0__tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory__v0;
    IData/*31:0*/ __Vdlyvval__tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory__v0;
    CData/*0:0*/ __Vdlyvset__tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory__v0;
    // Body
    __Vdlyvset__tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory__v0 = 0U;
    ...
    if ((1U & ((~ (IData)(vlSelf->rst)) | (IData)(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__ctrl_hold_flag_o)))) {
        vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_ex_offset_addr_o = 0U;
        ...
        vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_ex_base_addr_o = 0U;
    } else {
                                     ...
                                     : ((4U & vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_ex_inst_o)
                                        ...
                                        ((2U & vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_ex_inst_o)
                                          ? ((1U & vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_ex_inst_o)
                                              ...
                                              : 0U)
                                          : 0U)))) : 0U)
                    : 0U) : ((IData)(4U) + vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__pc_reg_pc_o));
    } else {
        __Vdlyvset__tb__DOT__soc_inst__DOT__riscv_inst__DOT__regs_inst__DOT__regs__v1 = 1U;
        __Vdly__tb__DOT__soc_inst__DOT__riscv_inst__DOT__pc_reg_pc_o = 0x80000000U;
    }
    if ((1U & ((~ (IData)(vlSelf->rst)) | (IData)(vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__ctrl_hold_flag_o)))) {
    ...
    if (__Vdlyvset__tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory__v0) {
        vlSelf->tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory[__Vdlyvdim0__tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory__v0] 
            = __Vdlyvval__tb__DOT__soc_inst__DOT__ram_inst__DOT__ram_template_inst__DOT__memory__v0;
    }
        ...
        if ((0x20U & vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o)) {
            if ((0x10U & vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__if_id_inst_o)) {
                ...
                vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_rs2_addr_o 
                    = (0x1fU & 0U);
                vlSelf->tb__DOT__soc_inst__DOT__riscv_inst__DOT__id_offset_addr_o = 0U;
