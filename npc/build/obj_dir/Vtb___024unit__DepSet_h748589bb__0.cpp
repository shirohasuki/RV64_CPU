...
VL_INLINE_OPT void Vtb___024unit____Vdpiimwrap_inst_fetch_TOP____024unit(QData/*63:0*/ raddr, QData/*63:0*/ &rdata) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtb___024unit____Vdpiimwrap_inst_fetch_TOP____024unit\n"); );
    // Body
    long long raddr__Vcvt;
    for (size_t raddr__Vidx = 0; raddr__Vidx < 1; ++raddr__Vidx) raddr__Vcvt = raddr;
    long long rdata__Vcvt;
    inst_fetch(raddr__Vcvt, &rdata__Vcvt);
    rdata = rdata__Vcvt;
}
