...
class DCACHE extends Module {
    ...
    val vMem    = Reg(Vec(16, (0, UInt(16.W))))             // 16组，8行，每行占一位
    val dMem    = Reg(Vec(16, (0, UInt(16.W))))             // 16组，8行，每行占一位
    val ageMem  = Reg(Vec(16, (0, UInt( 7.W))))             // 16组，三层age位
    val tagMem  = Reg(Vec(16, (Vec(8, (0, UInt(55.W))))))   // 16组，8行tag 
    val dataMem = Reg(Vec(16, (Vec(8, (Vec(4, (0, UInt(64.W)))))))) // 16组，8行,每行4个64位
