...
class EXU extends Module {
    ...
    val exce_list  = ListLookup(idex_ex.opcode, default_exce_list, Array(
        INST_TYPE_I     -> ListLookup(idex_ex.func3, default_exce_list, Array(
                            ...
                            INST_SLLI       -> List(Rd_Write, rd_addr,shift_left_unsigned(op1, op2, 6), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),
                            INST_SRI        -> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr, shift_right_signed(op1, op2, 6), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))), 
                                                                            List(Rd_Write, rd_addr, shift_right_unsigned(op1, op2, 6), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))))
        INST_TYPE_I_W   -> ListLookup(idex_ex.func3, default_exce_list, Array(
                            ...
                            INST_SRIW       -> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr, compress_shift_right_signed(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))), 
                                                                            List(Rd_Write, rd_addr, compress_shift_right_unsigned(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))))
        INST_TYPE_R_M   -> ListLookup(idex_ex.func3, default_exce_list, Array(
                            INST_ADD_SUB_MUL-> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr, sub(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)), // sub
                                                   idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr, mul(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)), // mul
                            ...
                            INST_XOR_DIV    -> Mux(idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr, div(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))), // div
                                                                              List(Rd_Write, rd_addr, xor(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))),  // xor
                            INST_OR_REM     -> Mux(idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr, rem(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))),  // rem
                                                                              List(Rd_Write, rd_addr,  or(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),    // or
                            INST_AND_REMU   -> Mux(idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr, rem_unsigned(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)), // remu
                            ...
                            INST_SR_DIVU    -> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr,   shift_right_signed(op1, op2, 6), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),  // SRA 算术右移
                                                   idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr,         div_unsigned(op1, op2, 6), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),  // divu 
                                                                              List(Rd_Write, rd_addr, shift_right_unsigned(op1, op2, 6), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))))  // SRL 逻辑右移
        INST_TYPE_R_M_W -> ListLookup(idex_ex.func3, default_exce_list, Array(
                            INST_ADDW_SUBW_MULW -> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr, compress_sub(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)), // sub
                                                       idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr, compress_mul(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),  // mul
                            ...
                            INST_SRW_DIVUW  -> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr,    compress_shift_right_signed(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),  // SRAW 算术右移
                                                   idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr,          compress_div_unsigned(op1, op2), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),  // divuw  
