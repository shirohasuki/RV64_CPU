...
class EXU extends Module {
    ...
    def shift_left_unsigned       (op1: UInt, op2: UInt, shamt_width: UInt): UInt = op1 << op2(shamt_width-1.U, 0)
    def shift_right_unsigned      (op1: UInt, op2: UInt, shamt_width: UInt): UInt = op1 >> op2(shamt_width-1.U, 0)
