...
class EXU extends Module {
    ...
    val exce_list  = ListLookup(idex_ex.opcode, default_exce_list, Array(
        INST_TYPE_I     -> ListLookup(idex_ex.func3, default_exce_list, Array(
                            ...
                            INST_SRI        -> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr, shift_right_signed(op1, op2, 6.U), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W))), 
        ...
        INST_TYPE_R_M   -> ListLookup(idex_ex.func3, default_exce_list, Array(
                            ...
                            INST_SR_DIVU    -> Mux(idex_ex.func7(5) === b1.U, List(Rd_Write, rd_addr,   shift_right_signed(op1, op2, 6.U), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),  // SRA 算术右移
                                                  (idex_ex.func7(0) === b1.U, List(Rd_Write, rd_addr,         div_unsigned(op1, op2, 6.U), NOMEM_Read, 0.U(64.W), NOMEM_Write, 0.U(8.W), 0.U(64.W), 0.U(64.W), NOTypeJ_Jump, 0.U(64.W)),  // divu 
