...
class EXWB extends Module {  
    ...
    exwb_wb.rd_waddr := dff_set(ctrl_exwb.exwb_flush_en, ctrl_exwb.exwb_stall_en, 1.U,  0.U(64.W), ex_exwb.rd_waddr)
    exwb_wb.rd_wen   := dff_set(ctrl_exwb.exwb_flush_en, ctrl_exwb.exwb_stall_en, 64.U, false.B,   ex_exwb.rd_wen  )
}
