...
class ICACHE extends Module {
    ...
    when (ren) {
        ...
        // }
        dataMem(idx)(0)         := DPIC_pmem_read_cacheline.io.rdata_0   
        dataMem(idx)(1)         := DPIC_pmem_read_cacheline.io.rdata_1   
        dataMem(idx)(2)         := DPIC_pmem_read_cacheline.io.rdata_2   
        dataMem(idx)(3)         := DPIC_pmem_read_cacheline.io.rdata_3   
        dataMem(idx)(4)         := DPIC_pmem_read_cacheline.io.rdata_4   
        dataMem(idx)(5)         := DPIC_pmem_read_cacheline.io.rdata_5   
        dataMem(idx)(6)         := DPIC_pmem_read_cacheline.io.rdata_6   
        dataMem(idx)(7)         := DPIC_pmem_read_cacheline.io.rdata_7   
