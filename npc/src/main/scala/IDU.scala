...
class IDU extends Module {
    ...
    var id_ex_list  = ListLookup(func37, List(0.U(64.W), 0.U(64.W), 0.U(5.W), 0.U(5.W), 0.U(64.W), false.B, 0.U(64.W), 0.U(64.W)), Array(
        BitPat("b000_0010011") -> List(reg_id.rs1_data, immI,            rs1_raddr,       0.U,          rd_addr,    1.B,   0.U,   0.U), //addi
        BitPat("b000_0110011") -> List(reg_id.rs1_data, reg_id.rs2_data, rs1_raddr,       rs2_addr,     rd_addr,    1.B,   0.U,   0.U), //add        
    ))
