...
class IDU extends Module {
    ...
    val decode_list  = ListLookup(opcode, default_decode_list, Array(
        ...
        INST_TYPE_R_M   -> ListLookup(func3, default_decode_list, Array(
                            ...
                            INST_SR_DIVU -> Mux(INST_TYPE_R_FUN7, List(redirect_id.rs1_rdata, Cat(Fill(58, 0.U), redirect_id.rs2_rdata(5, 0)), rs1_addr, rs2_addr, rd_addr, true.B, 0.U, 0.U), List(redirect_id.rs1_rdata, redirect_id.rs2_rdata, rs1_addr, rs2_addr, rd_addr, true.B, 0.U, 0.U))))
        ...
        INST_TYPE_L     -> ListLookup(func3, default_decode_list, Array(
                            INST_LB, INST_LH, INST_LW, INST_LD, INST_LBU, INST_LHU, INST_LWU -> List(redirect_id.rs1_rdata, immL, rs1_addr, rs2_addr, rd_addr, ture.B, redirect_id.rs1_rdata, immL)))
