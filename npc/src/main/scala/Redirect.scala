...
class Redirect extends Module {
    ...
    redirect_id.rs1_rdata := MuxCase(reg_redirect.rs1_rdata, ArraySeq.unsafeWrapArray(Array(
    ...
    redirect_id.rs2_rdata := MuxCase(reg_redirect.rs2_rdata, ArraySeq.unsafeWrapArray(Array(
