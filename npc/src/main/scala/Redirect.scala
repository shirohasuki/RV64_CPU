...
class Redirect extends Module {
    ...
    // ================ hit检测
    val rs1_id_ex_hit  = (id_redirect.rs1_addr === ex_redirect.rd_addr)  && ex_redirect.rd_wen  && (id_redirect.rs1_addr =/= 0.U)
    val rs1_id_mem_hit = (id_redirect.rs1_addr === mem_redirect.rd_addr) && mem_redirect.rd_wen && (id_redirect.rs1_addr =/= 0.U)
    val rs1_id_wb_hit  = (id_redirect.rs1_addr === wb_redirect.rd_addr)  && wb_redirect.rd_wen  && (id_redirect.rs1_addr =/= 0.U)

    val rs2_id_ex_hit  = (id_redirect.rs2_addr === ex_redirect.rd_addr)  && ex_redirect.rd_wen  && (id_redirect.rs2_addr =/= 0.U)
    val rs2_id_mem_hit = (id_redirect.rs2_addr === mem_redirect.rd_addr) && mem_redirect.rd_wen && (id_redirect.rs2_addr =/= 0.U)
    val rs2_id_wb_hit  = (id_redirect.rs2_addr === wb_redirect.rd_addr)  && wb_redirect.rd_wen  && (id_redirect.rs2_addr =/= 0.U)
